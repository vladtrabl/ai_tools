...
Read and follow the skill at `.claude/skills/subagent-feature-implementation/SKILL.md`.
...
4. Invoke specialist subagents directly via the Agent tool, one at a time.
